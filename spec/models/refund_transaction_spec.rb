...
describe Paynl::Api::RefundTransaction do
  ...
  describe "transaction" do
    ...
    it "should return a refundId for succesfull refund" do
      ...
      stub_request(:get, "https://1234token5678@rest-api.pay.nl/v2/Refund/transaction/xml/?amount=10&description=Test&processDate=2025-12-31&serviceId=SL-123-123&transactionId=my_transaction_id").
       with(
         headers: {
        'Accept'=>'*/*',
